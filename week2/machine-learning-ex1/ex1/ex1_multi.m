...
% Init Theta and Run Gradient Descent for each alpha
for a = 1:size(alphas, 2),
    theta = zeros(3, 1);
    [theta, J_history] = gradientDescentMulti(X, y, theta, alphas(a), num_iters);
    plot(1:numel(J_history), J_history, colors(a), 'LineWidth', 2);
    hold on;
